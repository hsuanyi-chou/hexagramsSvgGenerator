...
// --------------------- 巳 蛇 Snake ---------------------
export const earthlyBranchSnakeMonth = ({
  compare,
...
export const earthlyBranchSnakeDay = ({
  compare,
  handle12LongLife,
}: Pick<
  IEarthlyBranchProps,
...
export const earthlyBranchSnakeMutual = ({
  compare,
...
// --------------------- 午 馬 Horse ---------------------
export const earthlyBranchHorseMonth = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMonthEarthlyBranchReturn => {
  switch (compare) {
    case '子':
...
export const earthlyBranchHorseDay = ({
  compare,
  handle12LongLife,
}: Pick<
  IEarthlyBranchProps,
...
export const earthlyBranchHorseMutual = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMutualEarthlyBranchReturn => {
  switch (compare) {
    case '子':
