...
// --------------------- 丑 牛 Ox ---------------------
export const earthlyBranchOxMonth = ({
  compare,
...
export const earthlyBranchOxDay = ({
  compare,
  handle12LongLife,
}: Pick<
  IEarthlyBranchProps,
...
export const earthlyBranchOxMutual = ({
  compare,
...
// --------------------- 辰 龍 Dragon ---------------------
export const earthlyBranchDragonMonth = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMonthEarthlyBranchReturn => {
  switch (compare) {
    case '子':
...
export const earthlyBranchDragonDay = ({
  compare,
  handle12LongLife,
}: Pick<
  IEarthlyBranchProps,
...
export const earthlyBranchDragonMutual = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMutualEarthlyBranchReturn => {
  switch (compare) {
    case '子':
...
// --------------------- 未 羊 Goat ---------------------
export const earthlyBranchGoatMonth = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMonthEarthlyBranchReturn => {
  switch (compare) {
    case '子':
...
export const earthlyBranchGoatDay = ({
  compare,
  handle12LongLife,
}: Pick<
  IEarthlyBranchProps,
...
>): IDayEarthlyBranchReturn => {
  switch (compare) {
    case '子':
      if (
        isMonthWang({ target: compare, lunarMonth: handle12LongLife.month })
      ) {
        return ['帝旺'];
      } else {
        return ['囚'];
...
export const earthlyBranchGoatMutual = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMutualEarthlyBranchReturn => {
  switch (compare) {
    case '子':
...
// --------------------- 戌 狗 Dog ---------------------
export const earthlyBranchDogMonth = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMonthEarthlyBranchReturn => {
  switch (compare) {
    case '子':
...
export const earthlyBranchDogDay = ({
  compare,
  handle12LongLife,
}: Pick<
  IEarthlyBranchProps,
...
export const earthlyBranchDogMutual = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMutualEarthlyBranchReturn => {
  switch (compare) {
    case '子':
