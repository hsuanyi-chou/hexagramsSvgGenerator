...
// --------------------- 寅 虎 Tiger---------------------
export const earthlyBranchTigerMonth = ({
  compare,
...
export const earthlyBranchTigerMutual = ({
  compare,
...
export const earthlyBranchTigerDay = ({
  compare,
  handle12LongLife,
}: Pick<
  IEarthlyBranchProps,
...
// --------------------- 卯 兔 Rabbit---------------------
export const earthlyBranchRabbitMonth = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMonthEarthlyBranchReturn => {
  switch (compare) {
    case '子':
...
export const earthlyBranchRabbitMutual = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMutualEarthlyBranchReturn => {
  switch (compare) {
    case '子':
...
export const earthlyBranchRabbitDay = ({
  compare,
  handle12LongLife,
}: Pick<
  IEarthlyBranchProps,
