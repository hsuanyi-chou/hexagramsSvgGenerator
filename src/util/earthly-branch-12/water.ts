...
// --------------------- 子 水 rat ---------------------
export const earthlyBranchRatMonth = ({
  compare,
...
export const earthlyBranchRatMutual = ({
  compare,
...
export const earthlyBranchRatDay = ({
  compare,
  handle12LongLife,
}: Pick<
  IEarthlyBranchProps,
...
// --------------------- 亥 豬 pig ---------------------
export const earthlyBranchPigMonth = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMonthEarthlyBranchReturn => {
  switch (compare) {
    case '子':
...
export const earthlyBranchPigMutual = ({
  compare,
}: Pick<IEarthlyBranchProps, 'compare'>): IMutualEarthlyBranchReturn => {
  switch (compare) {
    case '子':
...
export const earthlyBranchPigDay = ({
  compare,
  handle12LongLife,
}: Pick<
  IEarthlyBranchProps,
