...
describe('BatchFateGuaSolver - 批量產生命卦 - 解卦', () => {
  describe(`世爻是否旺相(僅依年、空亡判)`, () => {
    [
      {
        date: '2020-06-01T11:20:00.000',
        guaName: '澤雷隨',
        description: '世爻: 辰、年: 子、月: 巳',
        expectResult: true,
      },
      {
        date: '2021-06-28T11:20:00.000',
        guaName: '火風鼎',
        description: '世爻: 亥、年: 丑、月: 午',
        expectResult: false,
      },
      {
        date: '2025-10-02T11:20:00.000',
        guaName: '火地晉',
        description: '世爻: 酉、年: 巳、月: 酉',
        expectResult: true,
      },
      {
        date: '2022-09-01T11:20:00.000',
        guaName: '水地比',
        description: '世爻: 卯、年: 寅、月: 酉',
        expectResult: true,
      },
      {
        date: '2022-09-02T11:20:00.000',
        guaName: '山地剝',
        description: '世爻: 水、年: 寅、月: 酉',
        expectResult: false,
      },
      {
        date: '2022-09-03T11:20:00.000',
        guaName: '坤為地',
        description: '世爻: 酉、年: 寅、月: 酉',
        expectResult: false,
      },
      {
        date: '2022-09-07T11:20:00.000',
        guaName: '雷地豫',
